module.export({default:()=>useSwitch});let _extends;module.link("@babel/runtime/helpers/esm/extends",{default(v){_extends=v}},0);let React;module.link('react',{"*"(v){React=v}},1);let useControlled,useForkRef,useIsFocusVisible;module.link('@mui/utils',{unstable_useControlled(v){useControlled=v},unstable_useForkRef(v){useForkRef=v},unstable_useIsFocusVisible(v){useIsFocusVisible=v}},2);
