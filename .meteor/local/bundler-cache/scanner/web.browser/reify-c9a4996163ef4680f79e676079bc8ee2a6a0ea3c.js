module.export({default:()=>useControllableReducer});let _extends;module.link("@babel/runtime/helpers/esm/extends",{default(v){_extends=v}},0);let React;module.link('react',{"*"(v){React=v}},1);let ActionTypes;module.link('./useListbox.types',{ActionTypes(v){ActionTypes=v}},2);let areArraysEqual;module.link('../utils/areArraysEqual',{default(v){areArraysEqual=v}},3);
