let _extends;module.link("@babel/runtime/helpers/esm/extends",{default(v){_extends=v}},0);let _objectWithoutPropertiesLoose;module.link("@babel/runtime/helpers/esm/objectWithoutPropertiesLoose",{default(v){_objectWithoutPropertiesLoose=v}},1);let React;module.link('react',{"*"(v){React=v}},2);let PropTypes;module.link('prop-types',{default(v){PropTypes=v}},3);let elementAcceptingRef,HTMLElementType,ownerDocument,useForkRef,createChainedFunction,useEventCallback;module.link('@mui/utils',{elementAcceptingRef(v){elementAcceptingRef=v},HTMLElementType(v){HTMLElementType=v},unstable_ownerDocument(v){ownerDocument=v},unstable_useForkRef(v){useForkRef=v},unstable_createChainedFunction(v){createChainedFunction=v},unstable_useEventCallback(v){useEventCallback=v}},4);let composeClasses;module.link('../composeClasses',{default(v){composeClasses=v}},5);let Portal;module.link('../Portal',{default(v){Portal=v}},6);let ModalManager,ariaHidden;module.link('./ModalManager',{default(v){ModalManager=v},ariaHidden(v){ariaHidden=v}},7);let FocusTrap;module.link('../FocusTrap',{default(v){FocusTrap=v}},8);let getModalUtilityClass;module.link('./modalUnstyledClasses',{getModalUtilityClass(v){getModalUtilityClass=v}},9);let useSlotProps;module.link('../utils',{useSlotProps(v){useSlotProps=v}},10);let useClassNamesOverride;module.link('../utils/ClassNameConfigurator',{useClassNamesOverride(v){useClassNamesOverride=v}},11);let _jsx;module.link("react/jsx-runtime",{jsx(v){_jsx=v}},12);let _jsxs;module.link("react/jsx-runtime",{jsxs(v){_jsxs=v}},13);
...
module.exportDefault(ModalUnstyled);