module.export({default:()=>useButton});let _extends;module.link("@babel/runtime/helpers/esm/extends",{default(v){_extends=v}},0);let React;module.link('react',{"*"(v){React=v}},1);let useForkRef,useIsFocusVisible;module.link('@mui/utils',{unstable_useForkRef(v){useForkRef=v},unstable_useIsFocusVisible(v){useIsFocusVisible=v}},2);let extractEventHandlers;module.link('../utils/extractEventHandlers',{default(v){extractEventHandlers=v}},3);
