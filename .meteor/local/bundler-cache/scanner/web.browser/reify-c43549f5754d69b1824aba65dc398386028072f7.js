module.export({default:()=>useInput});let _extends;module.link("@babel/runtime/helpers/esm/extends",{default(v){_extends=v}},0);let _formatMuiErrorMessage;module.link("@mui/utils",{formatMuiErrorMessage(v){_formatMuiErrorMessage=v}},1);let React;module.link('react',{"*"(v){React=v}},2);let useForkRef;module.link('@mui/utils',{unstable_useForkRef(v){useForkRef=v}},3);let useFormControlUnstyledContext;module.link('../FormControlUnstyled',{useFormControlUnstyledContext(v){useFormControlUnstyledContext=v}},4);let extractEventHandlers;module.link('../utils/extractEventHandlers',{default(v){extractEventHandlers=v}},5);
