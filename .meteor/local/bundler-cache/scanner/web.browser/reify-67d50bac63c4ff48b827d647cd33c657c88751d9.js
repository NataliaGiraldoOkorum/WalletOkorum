let _objectWithoutPropertiesLoose;module.link("@babel/runtime/helpers/esm/objectWithoutPropertiesLoose",{default(v){_objectWithoutPropertiesLoose=v}},0);let _extends;module.link("@babel/runtime/helpers/esm/extends",{default(v){_extends=v}},1);let React;module.link('react',{"*"(v){React=v}},2);let PropTypes;module.link('prop-types',{default(v){PropTypes=v}},3);let clsx;module.link('clsx',{default(v){clsx=v}},4);let composeClasses;module.link('@mui/base',{unstable_composeClasses(v){composeClasses=v}},5);let alpha;module.link('@mui/system',{alpha(v){alpha=v}},6);let capitalize;module.link('../utils/capitalize',{default(v){capitalize=v}},7);let styled;module.link('../styles/styled',{default(v){styled=v}},8);let useThemeProps;module.link('../styles/useThemeProps',{default(v){useThemeProps=v}},9);let buttonGroupClasses,getButtonGroupUtilityClass;module.link('./buttonGroupClasses',{default(v){buttonGroupClasses=v},getButtonGroupUtilityClass(v){getButtonGroupUtilityClass=v}},10);let ButtonGroupContext;module.link('./ButtonGroupContext',{default(v){ButtonGroupContext=v}},11);let _jsx;module.link("react/jsx-runtime",{jsx(v){_jsx=v}},12);
