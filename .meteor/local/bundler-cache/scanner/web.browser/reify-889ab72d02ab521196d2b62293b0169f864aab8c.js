let _extends;module.link("@babel/runtime/helpers/esm/extends",{default(v){_extends=v}},0);let _objectWithoutPropertiesLoose;module.link("@babel/runtime/helpers/esm/objectWithoutPropertiesLoose",{default(v){_objectWithoutPropertiesLoose=v}},1);let React;module.link('react',{"*"(v){React=v}},2);let PropTypes;module.link('prop-types',{default(v){PropTypes=v}},3);let useId,chainPropTypes,integerPropType;module.link('@mui/utils',{unstable_useId(v){useId=v},chainPropTypes(v){chainPropTypes=v},integerPropType(v){integerPropType=v}},4);let useSlotProps;module.link('../utils',{useSlotProps(v){useSlotProps=v}},5);let composeClasses;module.link('../composeClasses',{default(v){composeClasses=v}},6);let isHostComponent;module.link('../utils/isHostComponent',{default(v){isHostComponent=v}},7);let TablePaginationActionsUnstyled;module.link('./TablePaginationActionsUnstyled',{default(v){TablePaginationActionsUnstyled=v}},8);let getTablePaginationUnstyledUtilityClass;module.link('./tablePaginationUnstyledClasses',{getTablePaginationUnstyledUtilityClass(v){getTablePaginationUnstyledUtilityClass=v}},9);let useClassNamesOverride;module.link('../utils/ClassNameConfigurator',{useClassNamesOverride(v){useClassNamesOverride=v}},10);let _jsx;module.link("react/jsx-runtime",{jsx(v){_jsx=v}},11);let _createElement;module.link("react",{createElement(v){_createElement=v}},12);let _jsxs;module.link("react/jsx-runtime",{jsxs(v){_jsxs=v}},13);
...
module.exportDefault(TablePaginationUnstyled);