let _objectWithoutPropertiesLoose;module.link("@babel/runtime/helpers/esm/objectWithoutPropertiesLoose",{default(v){_objectWithoutPropertiesLoose=v}},0);let _extends;module.link("@babel/runtime/helpers/esm/extends",{default(v){_extends=v}},1);let React;module.link('react',{"*"(v){React=v}},2);let PropTypes;module.link('prop-types',{default(v){PropTypes=v}},3);let clsx;module.link('clsx',{default(v){clsx=v}},4);let chainPropTypes,visuallyHidden;module.link('@mui/utils',{chainPropTypes(v){chainPropTypes=v},visuallyHidden(v){visuallyHidden=v}},5);let composeClasses;module.link('@mui/base',{unstable_composeClasses(v){composeClasses=v}},6);let useTheme;module.link('../styles/useTheme',{default(v){useTheme=v}},7);let capitalize,useForkRef,useIsFocusVisible,useControlled,useId;module.link('../utils',{capitalize(v){capitalize=v},useForkRef(v){useForkRef=v},useIsFocusVisible(v){useIsFocusVisible=v},useControlled(v){useControlled=v},unstable_useId(v){useId=v}},8);let Star;module.link('../internal/svg-icons/Star',{default(v){Star=v}},9);let StarBorder;module.link('../internal/svg-icons/StarBorder',{default(v){StarBorder=v}},10);let useThemeProps;module.link('../styles/useThemeProps',{default(v){useThemeProps=v}},11);let styled,slotShouldForwardProp;module.link('../styles/styled',{default(v){styled=v},slotShouldForwardProp(v){slotShouldForwardProp=v}},12);let ratingClasses,getRatingUtilityClass;module.link('./ratingClasses',{default(v){ratingClasses=v},getRatingUtilityClass(v){getRatingUtilityClass=v}},13);let _jsx;module.link("react/jsx-runtime",{jsx(v){_jsx=v}},14);let _jsxs;module.link("react/jsx-runtime",{jsxs(v){_jsxs=v}},15);
