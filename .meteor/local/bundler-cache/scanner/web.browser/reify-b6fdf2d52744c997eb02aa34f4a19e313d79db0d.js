module.export({default:()=>useMenu});let _extends;module.link("@babel/runtime/helpers/esm/extends",{default(v){_extends=v}},0);let React;module.link('react',{"*"(v){React=v}},1);let useForkRef;module.link('@mui/utils',{unstable_useForkRef(v){useForkRef=v}},2);let useListbox,defaultListboxReducer,ActionTypes;module.link('../useListbox',{default(v){useListbox=v},defaultListboxReducer(v){defaultListboxReducer=v},ActionTypes(v){ActionTypes=v}},3);let useMenuChangeNotifiers;module.link('../MenuUnstyled/useMenuChangeNotifiers',{default(v){useMenuChangeNotifiers=v}},4);
