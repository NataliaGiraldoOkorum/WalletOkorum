module.export({default:()=>useSelectChangeNotifiers});let React;module.link('react',{"*"(v){React=v}},0);let useMessageBus;module.link('../utils/useMessageBus',{default(v){useMessageBus=v}},1);
