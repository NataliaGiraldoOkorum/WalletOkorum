let _extends;module.link("@babel/runtime/helpers/esm/extends",{default(v){_extends=v}},0);let _objectWithoutPropertiesLoose;module.link("@babel/runtime/helpers/esm/objectWithoutPropertiesLoose",{default(v){_objectWithoutPropertiesLoose=v}},1);let React;module.link('react',{"*"(v){React=v}},2);let PropTypes;module.link('prop-types',{default(v){PropTypes=v}},3);let clsx;module.link('clsx',{default(v){clsx=v}},4);let chainPropTypes;module.link('@mui/utils',{chainPropTypes(v){chainPropTypes=v}},5);let isHostComponent;module.link('../utils/isHostComponent',{default(v){isHostComponent=v}},6);let composeClasses;module.link('../composeClasses',{default(v){composeClasses=v}},7);let getSliderUtilityClass;module.link('./sliderUnstyledClasses',{getSliderUtilityClass(v){getSliderUtilityClass=v}},8);let useSlider,valueToPercent;module.link('../useSlider',{default(v){useSlider=v},valueToPercent(v){valueToPercent=v}},9);let useSlotProps;module.link('../utils/useSlotProps',{default(v){useSlotProps=v}},10);let useClassNamesOverride;module.link('../utils/ClassNameConfigurator',{useClassNamesOverride(v){useClassNamesOverride=v}},11);let _jsx;module.link("react/jsx-runtime",{jsx(v){_jsx=v}},12);let _jsxs;module.link("react/jsx-runtime",{jsxs(v){_jsxs=v}},13);
...
module.exportDefault(SliderUnstyled);